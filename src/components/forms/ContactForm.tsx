          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3 text-sm">
                  ...
                  >
                    Acepto los{' '}
                    <a className="font-medium text-primary-600 hover:underline dark:text-primary-500" href="/terms">
              ...
              <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                Nuestro equipo suele responder en un plazo de 24 a 48 horas. Mientras tanto, puedes consultar nuestras{' '}
                <a href="/#faq" className="font-medium text-primary-600 hover:underline dark:text-primary-500">
            ...
            {isError && (
              ...
              >
                ...
                <br />
                Prueba a refrescar la página y enviar el formulario de nuevo más tarde.
              </div>
            )}
