...
description: 'El software inmobiliario está en auge. ¿Realmente es rentable? Analizamos su impacto y beneficios para agencias en un entorno cada vez más digital.'
...
<EmailSignupCTA
  client:visible
  titleText="¿Te compensa invertir en software inmobiliario?"
  descriptionText="Calcula el ROI real de automatizar la captación y las visitas en tu agencia."
...
<EmailSignupCTA
  client:visible
  titleText="Implementa tu stack sin fricciones"
  descriptionText="Conecta Estavia con tu CRM y agenda visitas automáticamente sin llamadas."
  buttonText="Automatizar visitas ahora"
/>
...
<EmailSignupCTA
  client:visible
  titleText="Convierte tu operativa en datos y resultados"
  descriptionText="Recibe un plan accionable para digitalizar tu agencia en 14 días."
